...
import {columns} from "@/app/(admin)/admin/dashboard/manage-events/columns";
import {events} from "@/app/(admin)/admin/dashboard/manage-events/eventsdata";
            ...
            <Card
                ...
                <CardHeader className="relative z-10">
                    ...
                    <p className="text-sm text-muted-foreground">
                        Create an event and display it on your website.
                    </p>
                </CardHeader>
